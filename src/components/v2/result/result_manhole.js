...
import { ma4State, ma6State, me6State, manholeSumState, directMa4State } from "@/states/manhole_selector";
...
export default function ResultManhole() {
    ...
    const [directMa4, setDirectMa4] = useRecoilState(directMa4State);

    useEffect(() => {
        console.log('changed directMa4')
        if (directMa4 !== ma4?.count) {
                    ...
                    <tr>
                        ...
                        {/* <td className="border border-slate-600" style={{ display: "inline-flex" }}>
                            <input type="number"
                                ...
                                onChange={(e) => setDirectMa4(e.target.value) }/>
                            <button type="button" className="bg-rose-600 text-slate-100" style={{ width: 40 + '%' }}>적용</button>
                        </td> */}
