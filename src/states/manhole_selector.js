...
export const ma4State = selector({
    ...
    get: ({ get }) => {
        ...
        const count = Math.round(area * unitCount * ma4 / 1000 * densityConstant);
...
export const me6State = selector({
    ...
    get: ({ get }) => {
        ...
        const count = Math.round(area * unitCount * me6 / 1000 * densityConstant);
...
export const ma6State = selector({
    ...
    get: ({ get }) => {
        ...
        // const count = Math.round(scale * area / 1000);
        const count = Math.round(area * unitCount * ma6 / 1000 * densityConstant);
        // const count = Math.round(devArea * unitCount * ma6 * commonAdj * densityConstant / 1000 * 1000) / 1000;
