...
export const ma4State = selector({
    ...
    get: ({ get }) => {
        ...
        const count = Math.round(devArea * unitCount * ma4 * commonAdj * densityConstant / 1000 * 1000) / 1000;
...
export const me6State = selector({
    ...
    get: ({ get }) => {
        ...
        // const count = Math.round(scale * area / 1000);
        const count = Math.round(devArea * unitCount * me6 * commonAdj * densityConstant / 1000 * 1000) / 1000;
