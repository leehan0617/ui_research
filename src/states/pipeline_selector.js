...
export const p175State = selector({
    ...
    get: ({ get }) => {
        ...
        const scale = unitCount * p175 * commonAdj * densityConstant;
        ...
        const count2 = Math.round(scale * p175x2 * devArea / 1000 * 100) / 100;
...
export const p150State = selector({
    ...
    get: ({ get }) => {
        ...
        const scale = unitCount * p150 * commonAdj * densityConstant;
        ...
        const count2 = Math.round(scale * p150x2 * devArea / 1000 * 100) / 100;
        return { scale, count9, count6, count4, count2 }
    }
});
...
export const p100State = selector({
    ...
    get: ({ get }) => {
        ...
        // const scale = Math.round(unitCount * p100Í * 1000) / 1000;
        const scale = unitCount * p100 * commonAdj * densityConstant;
        ...
        const count2 = Math.round(scale * p100x2 * devArea / 1000 * 100) / 100;
        return { scale, count9, count6, count4, count2 }
    }
});
