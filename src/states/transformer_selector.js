...
export const kva75State = selector({
    ...
    get: ({ get }) => {
        ...
        const count = Math.round(devArea * unitCount * kva75 * singleAdj * densityConstant / 1000);
...
export const kva150State = selector({
    ...
    get: ({ get }) => {
        ...
        // const count = Math.round(scale * area / 1000);
        const count = Math.round(devArea * unitCount * kva150 * singleAdj * densityConstant / 1000);
...
export const kva300State = selector({
    ...
    get: ({ get }) => {
        ...
        // const count = Math.round(scale * area / 1000);
        const count = Math.round(devArea * unitCount * kva300 * singleAdj * densityConstant / 1000);
